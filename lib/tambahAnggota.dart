...
// KODE SUDAH JALAN DENGAN BAIK, SUDAH ISI KONFIRMASI, TAPI MASIH BELUM BISA UNTUK NOMOR INDUKNYA OTOMATIS
...
class _AddMemberPageState extends State<AddMemberPage> {
  ...
  Future<void> _confirmAddMember() async {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text("Konfirmasi"),
          content: const Text("Apakah anda yakin menambahkan anggota ini?"),
          actions: <Widget>[
            TextButton(
